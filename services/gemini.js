...
// Designed per the permanent architecture: specific, actionable CTAs that give
// viewers something to DO — not just "follow karo" x12.
// Groups: Engagement/Comment (14) · Save/Share (12) · Follow (12) · Action (12)
const CTA_POOL = [
  // ── Engagement — comment with specific prompt (14) ────────────────────────
  "Comment karo — what's your biggest money mistake?",
  "Tell me below — FD ya mutual fund — what do you use?",
  "Comment your SIP amount — even 100 rupees counts.",
  "Drop a number — how old were you when you started investing?",
  "Comment karo — kya aaj se start karoge?",
  "Tell me — 1 or 2? Which strategy do you follow?",
  "Comment 'YES' if this changed how you think about money.",
  "Drop your biggest finance question below — I'll answer.",
  "Comment the ONE thing you'll change after watching this.",
  "Tell me — did school ever teach you this? Comment below.",
  "Rate this tip — 1 to 10. Comment karo.",
  "Comment 'SEND' — I'll DM you the full breakdown.",
  "Which part surprised you most? Comment karo.",
  "Share this with ONE person who needs to hear it.",
  // ── Save / Share — specific reason to save (12) ───────────────────────────
  "Save this reel — you'll need it when you start investing.",
  "Save kar lo — reference ke liye kaam aayegi.",
  "Tag someone who still thinks FD is the best investment.",
  "Tag a friend who says 'investing is risky' — show them this.",
  "Send to your parents — they need to hear this today.",
  "Share this with your group — ek doston ki help karo.",
  "Tag someone who keeps saying 'kal se shuru karunga.'",
  "Save this — in 5 years you'll thank yourself.",
  "Screenshot the key stat — yaad rakhna hai.",
  "Send to someone who wastes money on things they don't need.",
  "Share karo — someone in your circle needs this right now.",
  "Tag the person who told you FD is safe — let them see this.",
  // ── Follow — specific value promise (12) ─────────────────────────────────
  "Follow for daily finance tips — real talk, no fluff.",
  "Follow karo — every day ek naya money lesson.",
  "Follow — I'll show you exactly how to build wealth step by step.",
  "Follow karo aur miss mat karna — next reel is even more important.",
  "Follow for more — because school never taught us this.",
  "Follow karo — your future self will be grateful.",
  "Hit follow — daily tips that actually make sense.",
  "Follow karo — paisa seekhna is the best investment.",
  "Follow for the full series — this is just the beginning.",
  "Follow — I explain finance in simple Hinglish, every day.",
  "Follow karo — no jargon, no confusion, just real money advice.",
  "Follow for part 2 — coming tomorrow.",
  // ── Action — specific next step to take (12) ─────────────────────────────
  "Open your bank app right now — start a SIP, even 500 rupees.",
  "Check your FD return rate today — then compare with inflation.",
  "Calculate your net worth this week — it takes 10 minutes.",
  "Review your monthly expenses this weekend — just once.",
  "Set up an emergency fund first — before any investment.",
  "Check your credit score today — it's free, takes 2 minutes.",
  "Talk to a fee-only financial advisor — not a product seller.",
  "Read your mutual fund's expense ratio — it matters more than you think.",
  "Increase your SIP by 10 percent this year — small step, big result.",
  "Set a money goal for this year — write it down, right now.",
  "Cancel one subscription you forgot about — redirect that money.",
  "Start tracking expenses from tomorrow — just 5 minutes a day.",
];
...
// ── Prompt builder (5-section master architecture) ────────────────────────────
function buildPrompt(topic) {
  return [

    // ── SECTION A: ROLE & CONTEXT ──────────────────────────────────────────────
    `You are a scriptwriter for short-form Indian finance reels (20-30 seconds).`,
    `Audience: urban Indians aged 20-35 who speak Hinglish daily.`,
    `You are writing a SPOKEN script — not a blog post, not an article.`,
    `Every line will be read aloud by a TTS voice. Write for the ear, not the eye.`,
    `Topic: "${topic}"`,
    ``,
    ...
    ``,
    `1. RATIO: ~75% English, ~25% Hindi. English for facts/numbers/finance. Hindi for emotion/flow.`,
    ``,
    `2. ENGLISH — ALWAYS keep these in English (never translate):`,
    `   SIP, FD, EMI, mutual fund, portfolio, returns, interest, compound interest,`,
    `   inflation, expense ratio, index fund, NIFTY, Sensex, equity, debt, tax,`,
    `   credit score, insurance, budget, income, savings, investment, wealth, loan`,
    ``,
    `3. HINDI — use only simple, common words every Indian knows:`,
    `   paisa, galti, sach, log, jaldi, ameer, kaam, accha, bura, zyada, kam,`,
    `   pehle, baad mein, samjho, dekho, socho, karo, nahi, abhi, aaj, toh, aur`,
    ``,
    `4. NEVER USE ROMAN HINDI for these — use their English equivalent instead:`,
    `   fayda → "benefit" | nuksan → "loss" | bachat → "saving" | mahina → "month"`,
    `   mehengai → "inflation" | vyaj → "interest" | rin → "loan" | suvidha → "benefit"`,
    `   karobaar → "business" | bhavishya → "future" | shiksha → "education"`,
    ``,
    `5. SWITCH LANGUAGES ONLY ONCE per sentence:`,
    `   WRONG: "Your paisa will grow aur returns milenge aur life badal jayegi"`,
    `   RIGHT: "Your money will grow — aur life badal jayegi"`,
    ``,
    `6. NO TRANSLATION PAIRS — never say the same thing in both languages:`,
    `   WRONG: "Save karo, bachat karo" | "Every day, har roz" | "Today, aaj"`,
    `   RIGHT: "Save karo" or "Har roz invest karo" — pick ONE language per idea`,
    ``,
    `7. MAX 3-SYLLABLE HINDI WORDS: longer Hindi words cause TTS issues.`,
    `   Replace with English: "zaroorat" → "need" | "samajhna" → "understand"`,
    `   Keep short ones: "galti", "paisa", "kaam", "sach" — these are fine`,
    ``,

    // ── SECTION C: STRUCTURE & ARC ────────────────────────────────────────────
    `REEL STRUCTURE — exactly ${MIN_SCENES}–${MAX_SCENES} scenes, total ${MIN_TOTAL_DURATION}–${MAX_TOTAL_DURATION}s:`,
    ``,
    `Scene 1  [hook]   : Grab attention in 2 seconds. MAX 10 words. English-first. Question OR surprising fact.`,
    `                    Examples: "FD ka sach nobody tells you."`,
    `                              "Biggest galti in SIP — are you making it?"`,
    `                              "Your savings lose value every year. Here's why."`,
    ``,
    `Scene 2  [pain]   : The specific problem. Viewer thinks "this is me." Use numbers if possible.`,
    ``,
    `Scene 3  [reveal] : The surprising truth that reframes everything. NOT generic advice.`,
    ``,
    `Scenes 4+ [action]: ONE specific, actionable step per scene. 8-15 words max. Direct.`,
    ``,
    `Scene -2 [payoff] : Short empowering close. Creates hope. NOT information.`,
    `                    Examples: "Aaj se paisa work karna shuru karo."`,
    `                              "Small step today — big result in 10 years."`,
    ``,
    `Scene -1 [cta]    : Specific call to action. NOT just "follow karo". Give them something to DO:`,
    `                    Examples: "Comment karo — what's your biggest money mistake?"`,
    `                              "Save this — you'll need it in 6 months."`,
    `                              "Tag someone who still uses FD only."`,
    `                              "Follow for daily finance tips — real talk, no fluff."`,
    ``,

    // ── SECTION D: QUALITY SELF-CHECK ─────────────────────────────────────────
    `BEFORE WRITING EACH LINE, CHECK:`,
    `  ✓ Read it aloud in your head — does it sound like a real person talking?`,
    `  ✓ Any Hindi word longer than 3 syllables? Replace with English.`,
    `  ✓ Two Hindi words next to each other? Break them up with an English word.`,
    `  ✓ Sentence over 15 words? Split it into two.`,
    `  ✓ Same idea in two languages in one line? Remove the duplicate.`,
    ``,
    `FORBIDDEN (never output these):`,
    `  ✗ "grows hai" / "works hai" / "goes hai" — say "grow hota hai" / "kaam karta hai"`,
    `  ✗ "did kiya" / "grew hua" — pick ONE language per tense`,
    `  ✗ "every day aaj" / "today aaj" / "silently chupke" — meaning duplication`,
    `  ✗ "people karta hai" — say "people karte hain" (plural agreement)`,
    `  ✗ Starting hook with: Kya / Agar / Jo / Tumhara — start with English`,
    ``,

    // ── SECTION E: JSON SCHEMA + FULL EXAMPLE ─────────────────────────────────
    `SCENE SCHEMA (7 required keys):`,
    `{ "text":"spoken line, max 12 words", "duration":3, "emotion":"shock|pain|insight|urgency|empathy|triumph|motivation|neutral", "layout":"center|split-left|split-right|stat-zoom|comparison|minimal|cta", "visualMetaphor":"leaking-wallet|treadmill|chain-rupee|money-tree|sleeping-money|shrinking-coin|lightbulb-rupee|bullseye-coin|calendar-growth|split-comparison|red-stamp|arrow-launch|default", "emphasisWord":"strongest word", "scenePurpose":"hook|pain|reveal|action|payoff|cta", "elements":[2-4 objects] }`,
    ``,
    `Layout: no two adjacent scenes same. hook→center|minimal, reveal→stat-zoom, action→split-left|split-right, payoff→minimal, cta→cta`,
    `Elements: type=[${ALLOWED_ELEMENT_TYPES.join(",")}] name=[${ALLOWED_ICON_NAMES.join(",")}] animation=[${ALLOWED_ANIMATIONS.join(",")}]`,
    ``,
    `FULL EXAMPLE (topic "FD returns" — match this STYLE, not this content):`,
    `[`,
    `  {"text":"FD ka sach nobody tells you.","duration":3,"emotion":"shock","layout":"center","visualMetaphor":"shrinking-coin","emphasisWord":"sach","scenePurpose":"hook","elements":[{"type":"icon","name":"bank","animation":"pop","keyword":"FD"},{"type":"arrow","direction":"down","animation":"grow","keyword":"losing"}]},`,
    `  {"text":"FD gives 6%. Inflation runs at 7%. You lose money — every year.","duration":4,"emotion":"pain","layout":"stat-zoom","visualMetaphor":"shrinking-coin","emphasisWord":"lose","scenePurpose":"pain","elements":[{"type":"icon","name":"chart","animation":"grow","keyword":"inflation"},{"type":"icon","name":"coin-stack","animation":"pop","keyword":"savings"}]},`,
    `  {"text":"Real return = FD rate minus inflation. Often negative.","duration":3,"emotion":"insight","layout":"split-left","visualMetaphor":"lightbulb-rupee","emphasisWord":"negative","scenePurpose":"reveal","elements":[{"type":"icon","name":"lightbulb","animation":"pop","keyword":"real"},{"type":"icon","name":"trend-down","animation":"grow","keyword":"negative"}]},`,
    `  {"text":"Debt mutual funds — 7 to 8 percent post-tax. Better option hai.","duration":3,"emotion":"urgency","layout":"split-right","visualMetaphor":"money-tree","emphasisWord":"better","scenePurpose":"action","elements":[{"type":"icon","name":"chart","animation":"grow","keyword":"returns"},{"type":"icon","name":"trend-up","animation":"pop","keyword":"better"}]},`,
    `  {"text":"Emergency fund mein FD — theek hai. Wealth building ke liye — nahi.","duration":4,"emotion":"insight","layout":"comparison","visualMetaphor":"split-comparison","emphasisWord":"wealth","scenePurpose":"action","elements":[{"type":"icon","name":"target","animation":"pop","keyword":"emergency"},{"type":"icon","name":"wallet","animation":"grow","keyword":"wealth"}]},`,
    ...
    `  {"text":"Tag someone who still uses FD for long-term savings.","duration":3,"emotion":"motivation","layout":"cta","visualMetaphor":"default","emphasisWord":"tag","scenePurpose":"cta","elements":[{"type":"icon","name":"person","animation":"pop","keyword":"tag"},{"type":"icon","name":"rupee","animation":"pulse","keyword":"savings"}]}`,
    `]`,
    ``,
    `Now write the complete JSON array for: "${topic}"`,
